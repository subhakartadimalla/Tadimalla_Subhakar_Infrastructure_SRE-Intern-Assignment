...
export default function Dashboard() {
  const { activeIncidents, loading, error, fetchIncidents, clearError } = useIncidentStore();
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">Live active incidents (auto-refresh every 5s)</p>
        </div>
      ...
      {loading ? <Loader label="Fetching incidents…" /> : null}
